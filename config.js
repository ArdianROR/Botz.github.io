...
const BOT_INFO = process.env.BOT_INFO || "YanzBot;Ardian;https://ibb.co.com/KK7hS7M";
const URL = process.env.URL || "https://www.instagram.com/@ard_0211";
const AUDIO_DATA = process.env.AUDIO_DATA || "YanzBot;Ardian;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "YanzBot;Ardian";
